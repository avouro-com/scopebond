...
| `gateway` | The policy-enforcement proxy (HTTP + MCP ingress): prevents, countersigns, logs, kill switch. `npx scopebond-gateway`. | `[PLANNED]` |
| `sdk` | Signing SDK for operators to sign action intents. | `[PLANNED]` |
